...
% Last Modified by GUIDE v2.5 19-Apr-2018 12:35:19
...
% --- Executes on button press in learnButt.
function learnButt_Callback(hObject, eventdata, handles)
% hObject    handle to learnButt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
baileyTest;

% --- Executes on button press in interactButt.
function interactButt_Callback(hObject, eventdata, handles)
% hObject    handle to interactButt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
interact;


% --- Executes on button press in testButt.
function testButt_Callback(hObject, eventdata, handles)
% hObject    handle to testButt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
typetest;
